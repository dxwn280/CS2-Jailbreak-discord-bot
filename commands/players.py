...
image_links = {
    ...
    "alien": "https://i.imgur.com/DhppoPN.png",
    "moti2": "https://i.imgur.com/PngkojV.png",
    "vortex": "https://i.imgur.com/qu3gxDF.png",
    "oasis": "https://i.imgur.com/YSkaedY.png",
...
def scrape_xml():
    ...
    if response.status_code == 200:
        ...
        # address = root.find('.//server/addr').text
...
async def players(ctx: discord.Member = None):
    ...
    image_data = ['avalanche', 'undertale', 'clouds', 'minecraft', 'quake', 'spy', 'peanut', 'vipinthemix', 'kwejsi', 'umbrella', "lego", "moti2", "vortex", "oasis"] #list of maps
    ...
    #split t's & ct's into their teams
    ...
    if playerinfo != "0":
            ...
            for i in range(0, len(ctlist)):
                if i % 2 == 0:
                    ctlist1.append(ctlist[i])
                if i % 2 == 1:
                    ctlist2.append(ctlist[i])
            ...
            embed.set_footer(text="connect 104.128.58.156")
